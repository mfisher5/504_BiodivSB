...
```{r}
water_raw <- read_delim(here::here("data","raw","LTER_monthly_bottledata_20190904.txt"),delim=";") %>%
  clean_names() %>%
  remove_empty("rows") %>%
  na_if(-99999) %>%
  na_if(99999)
...
write out.
```{r}
write.csv(water_means, here::here("data","Annual_CTD_WaterChemistry_MeanMax_2000-2018.csv"),row.names=FALSE)
```
<br>
